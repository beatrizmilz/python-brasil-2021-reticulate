...
### Acessando o conteúdo em R

Em um chunk em R, é só usar o nome do objeto:
...
### Acessando o conteúdo em Python 

Em um chunk em Python, usar `r.NOME_DO_OBJETO`:
...
sns.barplot(x = "lucro", y = "filme", data = r.lucro_pixar)
```
