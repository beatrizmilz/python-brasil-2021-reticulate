...
# Pacote reticulate + RStudio

---

## RStudio: Uma casa única para R e Python
...
- Escola de dados - curso de Python para inovação cívica

- Ana Dulce - https://twitter.com/4naDulceP
